      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center">
        ...
        <div className="bg-brand-surface-container-low p-6 rounded-2xl border border-brand-outline/10 w-full mb-8">
          <div className="flex justify-between items-center mb-4 pb-4 border-b border-brand-outline/10">
            <span className="font-label uppercase tracking-widest text-sm text-brand-outline font-bold">
              Rounds
            </span>
            <span className="font-display text-2xl text-brand-on-surface tabular-nums leading-none">
              {currentRound}
            </span>
          </div>
          <div className="flex justify-between items-center">
            ...
            <span className="font-display text-2xl text-brand-on-surface leading-none tabular-nums">
